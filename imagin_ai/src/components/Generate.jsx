  ...
  return (
    <div className="imageGen">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[14px] max-w-[500px]">Browse through a collection of imaginative and visually stunning images generated by Hugging Face API</p>
      </div>
